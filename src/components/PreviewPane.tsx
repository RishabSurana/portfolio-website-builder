  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-400">Review the AI-generated content before deploying</p>
      </div>
      ...
      <div className="flex justify-center pt-4">
        <button
          ...
          className="px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 disabled:from-slate-600 disabled:to-slate-700 text-white font-semibold rounded-xl transition-all duration-200 flex items-center gap-3 shadow-lg shadow-green-500/25"
        >
          {isDeploying ? (
            <>
